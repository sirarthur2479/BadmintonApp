...
- **Added:** 2026-07-12
- **Status:** done (TASK-042 → TASK-052, 2026-07-12; use-case: `ideas/use-cases/match-point-analysis.md`; phase 2 parked pending the shuttle-tracking pilot — see `research/shuttle-tracking.md`)
